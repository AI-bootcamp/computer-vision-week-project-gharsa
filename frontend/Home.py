...
def show_home():
    ...
    with open("/Users/rahafmasmali/Desktop/T2/computer-vision-week-project-gharsa/background1.png", "rb") as f:
        bg_bytes = f.read()
    bg_base64 = base64.b64encode(bg_bytes).decode()


    with open("/Users/rahafmasmali/Desktop/T2/computer-vision-week-project-gharsa/18 Khebrat Musamim Bold.ttf", "rb") as font_file:
...
.الرغبة موجودة… بس البداية مو واضحة
        ...
        st.image(
        "/Users/rahafmasmali/Desktop/T2/computer-vision-week-project-gharsa/Screenshot 1446-11-02 at 12.48.26 AM.png",
        caption="ممر طويق"
    )
